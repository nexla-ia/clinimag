...
const PILLARS = [
  {
    ...
    intro: 'Ninguém da Med Mag abre o chat de um paciente por curiosidade ou pra uso comercial. Em nenhuma hipótese usamos seus dados pra treinar IA externa, vender insight ou benchmark sem anonimizar.',
    steps: [
  ...
  },
  {
    ...
    intro: 'A equipe Med Mag acompanha números, não conteúdo: tempo de resposta médio, taxa de no-show, volume de mensagens. Isso vira recomendação concreta pra sua operação melhorar — não relatório de cotação pra terceiros.',
    steps: [
  ...
  },
  {
    ...
    intro: 'Contrato com cláusula de tratamento de dados, DPO designado pela Med Mag, política de retenção configurável por clínica. Cumprimos os direitos do paciente — acesso, retificação e exclusão — em prazos legais.',
    steps: [
      ...
      { title: 'DPO designado', desc: 'Med Mag tem encarregado de proteção de dados (DPO) responsável por dúvidas. Email direto pra ele aparece no rodapé do contrato — sem URA, sem ticket genérico.' },
  ...
  },
  {
    ...
    bg: '#ECFEFF',
    emoji: '🗄️',
    title: 'Você é o controlador, a Med Mag é operadora',
    subtitle: 'Os dados são da sua clínica — você pode levar embora',
    intro: 'Os dados dos pacientes são da sua clínica. A Med Mag processa em nome de vocês, conforme contrato. Se quiser sair da plataforma, faz a exportação completa em CSV/JSON — leva embora tudo que é seu.',
    steps: [
      { title: 'Você é o controlador (LGPD)', desc: 'Pela lei, quem decide o que faz com os dados dos pacientes é a clínica — não a Med Mag. A gente só processa em nome de vocês conforme o contrato.' },
      ...
      { title: 'Migração assistida', desc: 'Se você decidir ir pra outra plataforma, a equipe Med Mag ajuda a migrar — sem ressentimento. Não é vingança fazer cliente ficar refém.' },
  ...
  },
  {
    ...
    subtitle: 'O que a Med Mag vê e o que NÃO vê',
    intro: 'Aqui está exatamente o que a equipe Med Mag acessa no dia-a-dia e o que nunca chega aos olhos dela sem autorização. Sem rodeio, sem letra miúda.',
    steps: [
      { title: '✅ Métricas agregadas', desc: 'Volume, tempo, conversão (números, não nomes). Aparecem no painel da Med Mag pra acompanhar performance.' },
      ...
      { title: '❌ Senhas dos seus operadores', desc: 'São guardadas com hash. Nem o admin do banco da Med Mag consegue ver — só você sabe a sua.' },
    ],
  ...
  },
  {
    ...
    tip: 'Sem maquiar, sem esconder. Reputação se constrói com transparência em momento difícil — é assim que a Med Mag joga.',
  },
]
